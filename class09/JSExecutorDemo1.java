...
public class JSExecutorDemo1 extends CommonMethods {
    public static void main(String[] args) {
        ...
        //js.executeScript("arguments[0].style.backgroundColor='blue'",userNameTxtBox); //solid color

        js.executeScript("arguments[0].style.border='5px solid green'", userNameTxtBox); //5 pixel border color
